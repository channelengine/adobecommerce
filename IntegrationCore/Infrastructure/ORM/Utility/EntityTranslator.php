...
namespace ChannelEngine\ChannelEngineIntegration\IntegrationCore\Infrastructure\ORM\Utility;

use ChannelEngine\ChannelEngineIntegration\IntegrationCore\Infrastructure\ORM\Entity;
use ChannelEngine\ChannelEngineIntegration\IntegrationCore\Infrastructure\ORM\Exceptions\EntityClassException;
use ChannelEngine\ChannelEngineIntegration\IntegrationCore\Infrastructure\ORM\IntermediateObject;

/**
 * Class EntityTranslator
 *
 * @package ChannelEngine\ChannelEngineIntegration\IntegrationCore\Infrastructure\ORM\Utility
 */
class EntityTranslator
{
    /**
